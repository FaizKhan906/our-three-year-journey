...
const SlideMissing = ({ onNext }: { onNext: () => void }) => {
  return (
    <div className="relative h-full w-full flex flex-col bg-dark-gradient overflow-hidden">
      ...
      >
        <img src={missingImg} alt="Missing you" className="w-full h-full object-cover" />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-16 relative z-10">
        ...
        >
          Baby bohot months se mile nhi hum 🥺 College khatam hogya, me job pe hu toh time milna mushkil hai... 
          but me tumko bohot miss karta hu sweetu 😢💕 I miss your kiss, I miss your hug, I miss your touch, 
          I miss everything about you jaan... bas hum sabr rakhenge okay? 
          Jaldi milenge InshaAllah 🤲🏻❤️
        </motion.p>
